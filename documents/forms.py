...
class ConsentForm(forms.ModelForm):
    class Meta:
        model = Consent# Id photos will need camera access
        fields = ('front_id', 'back_id', 'first_name', 'last_name', 'preferred_pronouns', 'age', 'birth_date', 'phone_number', 'email', 'address_line_1', 'address_line_2', 'city', 'state_province', 'postal_zip_code', 'tattoo_description', 'tattoo_placement', 'connection', 'under_influence', 'pregnant_or_nursing', 'communicable_disease', 'skin_conditions', 'medical_history', 'permanent', 'permanent_init', 'social_media_perm', 'social_media_perm_init', 'refund', 'refund_init', 'allergen_disclosure', 'allergen_disclosure_init', 'aftercare', 'aftercare_init', 'infection', 'infection_init', 'compensation', 'compensation_init', 'allergen_risk', 'allergen_risk_init', 'accurate_info', 'accurate_info_init', 'not_minor', 'not_minor_init', 'signed_date', 'signature')
        widgets = {
            'preferred_pronouns': forms.RadioSelect(choices=[("he", "he/him"),("she", "she/her"),("they", "they/them"),("other", "other")]),
            ...
            'signature': JSignatureWidget(jsignature_attrs={'UndoButton': True, "ResetButton": True, 'width': 600, 'height': 100}),
        }

    def __init__(self, *args, **kwargs):
        super(ConsentForm, self).__init__(*args, **kwargs)
        # Remove the initial empty choice from the fields
