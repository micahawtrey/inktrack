...
import { handleInputChange, handleCheckBoxChange } from "../utils/inputChangeUtils"
    ...
    return (
        <div id="acknowledgementAndWaiver" >
            ...
            <div className="form-check">
                <input onChange={(e) => handleCheckBoxChange(e, formData, setFormData, inputData, setInputData)} type="checkbox" className="form-check-input" name="permanent" id="permanent" />
            ...
            <div className="form-check">
                <input onChange={(e) => handleCheckBoxChange(e, formData, setFormData, inputData, setInputData)} type="checkbox" className="form-check-input" value="" name="social_media_perm" id="social_media_perm" />
            ...
            <div className="form-check">
                <input onChange={(e) => handleCheckBoxChange(e, formData, setFormData, inputData, setInputData)} type="checkbox" className="form-check-input" value="" name="refund" id="refund" />
            ...
            <div className="form-check">
                <input onChange={(e) => handleCheckBoxChange(e, formData, setFormData, inputData, setInputData)} type="checkbox" className="form-check-input" value="" name="allergen_disclosure" id="allergen_disclosure" />
            ...
            <div className="form-check">
                <input onChange={(e) => handleCheckBoxChange(e, formData, setFormData, inputData, setInputData)} type="checkbox" className="form-check-input" value="" name="aftercare" id="aftercare" />
            ...
            <div className="form-check">
                <input onChange={(e) => handleCheckBoxChange(e, formData, setFormData, inputData, setInputData)} type="checkbox" className="form-check-input" value="" name="infection" id="infection" />
            ...
            <div className="form-check">
                <input onChange={(e) => handleCheckBoxChange(e, formData, setFormData, inputData, setInputData)} type="checkbox" className="form-check-input" value="" name="compensation" id="compensation" />
            ...
            <div className="form-check">
                <input onChange={(e) => handleCheckBoxChange(e, formData, setFormData, inputData, setInputData)} type="checkbox" className="form-check-input" value="" name="allergen_risk" id="allergen_risk" />
            ...
            <div className="form-check">
                <input onChange={(e) => handleCheckBoxChange(e, formData, setFormData, inputData, setInputData)} type="checkbox" className="form-check-input" value="" name="accurate_info" id="accurate_info" />
            ...
            <div className="form-check">
                <input onChange={(e) => handleCheckBoxChange(e, formData, setFormData, inputData, setInputData)} type="checkbox" className="form-check-input" value="" name="not_minor" id="not_minor" />
            ...
            <div className="form-group mb-3">
                ...
                <div className="form-group">
                    <input onChange={(e) => handleInputChange(e, formData, setFormData, inputData, setInputData)} type="date" className="form-control w-50" value={formData.signed_date} name="signed_date" id="signed_date" />
                </div>
            </div>
